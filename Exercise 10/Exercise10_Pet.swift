...
// Creates a Pet class, which will be used to create other classes
// Note: No special syntax is needed for using the class as a superclass, or overriding the functions in the future
